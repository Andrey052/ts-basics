...
function formattedUserData(firstName: string, lastname: string, age: number = 'Нет данных', hometown: string = 'Нет данных') {
    return `
      Имя: ${firstName};
      Фамилия: ${lastName};
      Возраст: ${age};
  ...
  function formattedUserData2(firstName: string, lastname: string, age: number = 'Нет данных', hometown: string = 'Нет данных') {}
   console.log(`
      Имя: ${firstName};
      Фамилия: ${lastName};
      Возраст: ${age};
